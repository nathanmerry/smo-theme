			...
			<?php include 'includes/topbar.php'; ?>
				 ...
				 <form class="register" id="opt-out-form" action="" method="post">
				 	...
				 	<?php if(!empty($alerts['success'])) { ?>
						<div class="row">
						            <div class="aalert alert-success fade in alert-dismissable" data-alert="">
				    ...
				    <div class="row">
				        ...
				        <div class="small-12 medium-7 columns text-left">
				            <div class="input-contain">
				                <input type="text" name="mobile_number" id="mobile_number" class="form-input" maxlength="30" size="30">
				                <label id="label_mobile_number" for="mobile_number" class="error"></label>
				             </div>
				        </div>
				    </div>
				    <div class="row">
				        <div class="small-12 medium-5 columns text-left">
				            Post Code<span class="star">*</span>
				        </div>
				        <div class="small-12 medium-7 columns text-left">
				            <div class="input-contain">
				                <input type="text" name="post_code" id="post_code" class="form-input" maxlength="30" size="30">
				                <label for="post_code" id="label_post_code" class="error"></label>
				            </div>
				            <input type="hidden" name="owner" id="owner" value="PINKY" />
				            <h4 id="success-alert" class="success"></h4>
				            <input id="sms-out-submit" name="submit" class="apply_button button large" type="button" value="UnSubscribe" name="UnSubscribe" />
				        </div>
				    </div>
				</form>
