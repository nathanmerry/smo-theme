...
if ($result->num_rows > 0) {
	...
	while($row = $result->fetch_assoc()) {
		...
		$GLOBALS['rapr'] = $row["apr"];
		$GLOBALS['max_lt'] = $row["max_lt"];
		$GLOBALS['min_lt'] = $row["min_lt"];
		$GLOBALS['max_la'] = $row["max_la"];
		$GLOBALS['min_la'] = $row["min_la"];
		$GLOBALS['interestrates'] = $row["interestrates"];
		$GLOBALS['legal'] = $row["legal"];
		$GLOBALS['how_it_works'] = $row["how_it_works"];
		$GLOBALS['terms'] = $row["terms"];
		$GLOBALS['privacy'] = $row["privacy"];
		$GLOBALS['rep_example'] = $row["rep_example"];
		$GLOBALS['increments'] = $row["increments"];
