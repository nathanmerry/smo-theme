<div id="main">
	...
	<div class="row margin-top-large">
		<div class="small-12 columns">
			...
			<h2>Welcome to our website <?php include 'php/url.php' ?> (the "Site").</h2>
		</div>
	</div>
	...
	<div class="row">
		<div class="small-12 columns">
			<div>
			  <div><strong>ACCEPTANCE OF TERMS</strong> <br>
			    <br>
			    ...
			    <p> All intellectual property rights, copyright or trademarks used   in the   Website and its content including without limitation the   design, text,   graphics and all software and source codes connected   with the Website   are owned by <?php include 'php/name.php' ?>. </p>
			    ...
			    <br>
			    <p> We try our hardest to make every effort to ensure that the   service   you receive from this website is excellent; however, we   understand that   sometimes things may not fully work to your   expectations.  If you would   like to make a formal complaint, please   email us your concerns to complaints@<?php include 'php/url.php' ?> or   alternatively you can send your complaint   in writing to <?php include 'php/name.php' ?>, <?php include 'php/address.php' ?> </p>
			    ...
			    <br>
			    <p><?php include 'php/legal-text.php' ?></p>
			    <p>Last updated: 20/02/2017</p>
		      </div>
		  </div>
